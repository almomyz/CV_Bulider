...
<div class="resume">
   <div class="resume_left">
     ...
     <div class="resume_content">
       <div class="resume_item resume_info">
         <div class="title">
           <p class="bold">-: الـمعـلومـات الـشخصـيـة</p>
       ...
       <div class="resume_item resume_social">
         ...
         <ul>
           <li>
             ...
             <div class="data">
               <p class="semi-bold">-: اللغه الام</p>
           ...
           <li>
             ...
             <div class="data">
               <p class="semi-bold">-: اللغات الاخرى</p>
  ...
  <div class="resume_right">
    <div class="resume_item resume_about">
        <div class="title">
           <p class="bold">-: مـعلومـات عـامـه</p>
         </div>
    ...
    <div class="resume_item resume_education">
      <div class="title">
           <p class="bold">-:الـمؤهـلات الـتعـلـيمـية</p>
         </div>
      <ul>
            <li>
